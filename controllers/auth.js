...
exports.signup = (req, res) => {
  ...
  User.findOne({email}, (err, email) => {
    ...
    user.save((err, user) => {
      ...
      // Send Email
      sendGridEmail(user.email, "Thanks for Signing up!", `You have signed up & this is your User ID: ${user._id} \n\n Please keep it safe.. \n\n Happy Coding, \n Bordo Team `)
      res.json({
...
exports.signin = (req, res) => {
  ...
  User.findOne({email}, (err, user) => {
    ...
    // Send Email
    sendGridEmail(user.email, "Sign-in Alert", "You have signed in to our application now. This is an alert... \n\n Happy Coding, \n Bordo Team")
  ...
  User.find({email}, (err, user) => {
    ...
    User.findByIdAndUpdate(
      ...
      (err, user) => {
        ...
        sendGridEmailResetPassword(user.email, "Bordo Verification", "This is your verification code" , user.verification_code)
        user.salt = undefined;
  ...
  User.findById(id).exec((err, user) => {
    ...
    User.findByIdAndUpdate(
      ...
      (err, user) => {
        ...
        sendGridEmail(user.email, `Your password had been changed..... \n\n Happy Coding, \n Bordo Team`)
        res.json({
          status: "Success",
          id: user._id,
...
exports.contactEmail = (req, res) => {
  ...
  sendGridEmail("wwbusrakeskin@gmail.com", subject, `Email: ${email} \n\n ${message}`)

  
  sendGridEmail(email, "Email Recieved", "Your Message/Inquiry was successfully recieved. \n Bordo Team will get back to you as soon as possible. \n\n Happy Coding\n Bordo Team with ❤️")
